  ...
  return (
    <div className="space-y-6">
      ...
      <div className="gradient-primary rounded-2xl p-6 md:p-8 text-white">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-2">Bem-vindo ao AvantisTube Channels</h1>
      ...
      {top3LongformByViews7Days.length > 0 && (
        <div>
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
            <h2 className="text-xl md:text-2xl font-bold leading-tight">Top 3 Vídeos Longos - Views dos Últimos 7 Dias</h2>
            <Button variant="outline" size="sm" onClick={() => navigate("/monitored")} className="w-full sm:w-auto">
              Ver Todos
            </Button>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      {top3ShortsByViews7Days.length > 0 && (
        <div>
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
            <h2 className="text-xl md:text-2xl font-bold leading-tight">Top 3 Shorts - Views dos Últimos 7 Dias</h2>
            <Button variant="outline" size="sm" onClick={() => navigate("/monitored")} className="w-full sm:w-auto">
              Ver Todos
            </Button>
          </div>
      ...
      {recentMy.length > 0 && (
        <div>
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
            <h2 className="text-xl md:text-2xl font-bold">Meus Canais</h2>
            <Button variant="outline" size="sm" onClick={() => navigate("/my-channels")} className="w-full sm:w-auto">
              Ver Todos
            </Button>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
